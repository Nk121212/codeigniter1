...
<html>
<head>
    <title>CETAK BUKTI PENYERAHAN</title>
    <style>
        td{
            font-size: 10px;
        };
...
<body>  
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td colspan="6" align="center">
                <div style="text-align:center; font-size:100%;"><b>BUKTI PENYERAHAN</b></div>
            </td>
        </tr>

        <tr>
            <td colspan="3" align="left">NO. BUKTI PENYERAHAN : <strong><?php echo $hasil['id_bukti'];?></strong> *</td>
                ...
                <table border="1" align="center" width="100%">
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <table border="0" width="100%">
                                <tr><td colspan="6"><strong>DAFTAR BARANG YANG DISERAHKAN : </strong></td></tr>
    ...
    <?php }; endforeach;?>
    <label style="font-size: 10px;">Ket : * = BUKTI PENYERAHAN ini silahkan di print jika memang diperlukan.</label>
    <br>
