...
<html>
<head>
    <title>CETAK BUKTI SERVICE</title>
    <style>
        td{
            font-size: 10px;
        };
...
<body>  
    ...
    <?php foreach($data_bukti_service->result_array() as $hasil): { ?>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td colspan="6" align="center">
                <div style="text-align:center; font-size:100%;"><b>BUKTI SERVICE</b></div>
            </td>
        </tr>

        <tr>
            <td colspan="3" align="left">NO. BUKTI SERVICE : <strong><?php echo $hasil['id_bukti'];?></strong> *</td>
                ...
                <table border="1" align="center" width="100%">
                    ...
                    <tr>
                        <td colspan="6">
                            ...
                            <table border="0" width="100%">
                                <tr><td colspan="6"><strong>ANALISA KERUSAKAN DAN TINDAKAN PERBAIKAN / SERVICE : </strong></td></tr>
                                <tr><td colspan="6"><?php echo $hasil['keterangan'];?></td></tr>                                                                 
                                <tr><td colspan="6"><br></td></tr>                                            
                                
                                <tr>                                    
                                    <td colspan="3" align="center" width="50%">
                                        <div style="text-align: center;">Teknisi IT</div>
                                    </td>
                                    <td colspan="3" align="center" width="50%">
    ...
    <?php }; endforeach;?>
    <label style="font-size: 10px;">Ket : * = BUKTI SERVICE ini silahkan di print jika memang diperlukan.</label>
    <br>
