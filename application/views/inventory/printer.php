...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Printer List</h3>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#merk_modal"><i class="fa fa-plus"></i> Tambah Printer</button>
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a href="'.base_url().'index.php/C_printer/del_printer/'.$id.'" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                            <a href="'.base_url().'index.php/C_printer/edit_page/'.$id.'" class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i> Edit</a>
                                        </td>
                                    </tr>
                                ';
                                $no ++;
        ...
        <div id="stok_modal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <form action="<?php echo base_url();?>index.php/C_printer/add_stok" method="post">
                
                    <div class="modal-body">
                        
                        Printer :
                        <select name="id_printer" id="id_printer" class="form-control" required>
        ...
        <div class="modal fade" id="merk_modal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo base_url();?>index.php/C_printer/add_printer" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <select name="type" id="type" class="form-control">
                            <?php 
                                $qmerk = $this->db->query("
                                    select * from master_type where hapus is null and status = 1 and kat = 7
                                ");
