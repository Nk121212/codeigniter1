...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Mouse List</h3>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        ...
        <button class="btn btn-success" data-toggle="modal" data-target="#merk_modal"><i class="fa fa-plus"></i> Tambah Mouse</button>
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <a href="'.base_url().'index.php/C_mouse/del_mouse/'.$id.'" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                            <a href="'.base_url().'index.php/C_mouse/edit_page/'.$id.'" class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i> Edit</a>
                                        </td>
                                    </tr>
                                ';
                                $no ++;
        ...
        <div id="stok_modal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <form action="<?php echo base_url();?>index.php/C_mouse/add_stok" method="post">
                
                    <div class="modal-body">
                        
                        Mouse :
                        <select name="id_mouse" id="id_mouse" class="form-control" required>
                            ...
                            <?php
                                ...
                                foreach($qhdd->result() as $dh){
                                    echo '
                                        <option value="'.$dh->id.'">'.$dh->nama_merk.' - '.$dh->nama_type.'</option>
                                    ';
                                }
                            ?>
                        </select>
        ...
        <div class="modal fade" id="merk_modal" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Add New Mouse</h4>
                </div>

                <form action="<?php echo base_url();?>index.php/C_mouse/add_mouse" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <select name="type" id="type" class="form-control">
                            <?php 
                                $qmerk = $this->db->query("
                                    select * from master_type where hapus is null and status = 1 and kat = 5
                                ");
