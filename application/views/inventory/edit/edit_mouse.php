...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Edit Mouse</h3>
        </div>
    </div>

    <div class="col-lg-12">

        <form action="<?php echo base_url();?>index.php/C_mouse/update_mouse" method="post">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url();?>index.php/C_mouse/view_mouse" type="button" class="btn btn-default" data-dismiss="modal">Cancel</a>
