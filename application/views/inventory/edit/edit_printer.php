...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <h3 class="page-header">Edit Printer</h3>
        </div>
    ...
    <div class="col-lg-12">
        ...
        <form action="<?php echo base_url();?>index.php/C_printer/update_printer" method="post">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url();?>index.php/C_printer/view_printer" type="button" class="btn btn-default" data-dismiss="modal">Cancel</a>
