<div id="page-wrapper" style="background-color:#d2f7d6;">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">PROOF OF SERVICE</h3>
        </div>
    </div>
...
<!-- START -->
        ...
        <form action="<?php echo base_url('index.php/bukti/simpanbuktiservice'); ?>" method="post">
            ...
            <div class="col-lg-12">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <td colspan="3">Analysis And Corrective Action / Service</td>
                    </tr>

                    <tr>
                        <td colspan="3">
                            <textarea class="col-md-12 col-sm-12 col-xs-12" name="txt_ket" id="txt_ket" placeholder="Explain" rows="6" required></textarea>
                        </td>
                    </tr>
