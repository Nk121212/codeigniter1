<div id="page-wrapper" style="background-color:#d2f7d6;">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">EDIT PROOF OF SERVICE</h3>
        </div>
    </div>
...
<!-- START -->
        ...
        <form action="<?php echo base_url('index.php/bukti/simpaneditbuktiservice'); ?>" method="post">
