...
<head>
    ...
    <!-- 
    <link href="<?php echo base_url(); ?>css/bootstrap.min.css" rel="stylesheet" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    ...
    <script src="<?php echo base_url(); ?>js/bootstrap.bundle.min.js" integrity="sha384-pjaaA8dDz/5BgdFUPX6M/9SUZv4d12SUPF0axWc+VRZkx5xU3daN+lYb49+Ax+Tl" crossorigin="anonymous"></script>
    --> 
...
<!-- ISI / CONTENT WEB MULAI DARI SINI -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
