...
class ApproveController extends CI_Controller {
    ...
    function update_approve(){
        ...
        $cek_history = $this->db->query("select approve,statuz,dept from tbl_permintaan where id_permintaan = '$id'");
        ...
        //echo $approve;
        if($approve != 0 || $hapus == 1){
            //jangan update lagi
            echo 'Permintaan Sudah Di Response';
        }else{
            $cek = $this->db->query("select acc from tbl_permintaan where id_permintaan = '$id'");
            $rows = $cek->row();
            $acc = $rows->acc;
    
            if($acc == 1){
    
                //echo 'Update table kondisi = Permintaan Service Diterima Atasan </br> jenis_permintaan = 1';
                $data = array(
                    'kondisi' => 'Permintaan Service Diterima Atasan',
                    'approve' => 1,
                    'jenis_permintaan' => 1
                );
             ...
             $query2 = "insert into tbl_permintaan_log
                ...
                values 
                (concat(uuid_short()), ?, 'Permintaan Service Diterima Atasan', ?, now(), ?, ?);";
                ...
                //echo 'Update table kondisi = Permintaan Barang Diterima Atasan </br> jenis_permintaan = 2';
    
                $data = array(
                    'kondisi' => 'Permintaan Barang Diterima Atasan',
                    'approve' => 1,
                    'jenis_permintaan' => 2
                );
                $this->db->where('id_permintaan', $id);
             ...
             $query2 = "insert into tbl_permintaan_log
                (id, id_permintaan, statuz, keterangan, pada, oleh, ip_add) 
                values 
                (concat(uuid_short()), ?, 'Permintaan Barang Diterima Atasan', ?, now(), ?, ?);";
                ...
                //echo 'Update table kondisi = Permintaan Aplikasi Diterima Atasan </br> jenis_permintaan = 3';
    
                $data = array(
                    'kondisi' => 'Permintaan Aplikasi Diterima Atasan',
                    'approve' => 1,
                    'jenis_permintaan' => 3
                );
                $this->db->where('id_permintaan', $id);
             ...
             $query2 = "insert into tbl_permintaan_log
                (id, id_permintaan, statuz, keterangan, pada, oleh, ip_add) 
                values 
                (concat(uuid_short()), ?, 'Permintaan Aplikasi Diterima Atasan', ?, now(), ?, ?);";
    ...
    function update_reject(){
        ...
        if($approve != 0 || $hapus == 1){
            ...
            if($acc == 1){
                ...
                //echo 'Update table kondisi = Permintaan Service Diterima Atasan </br> jenis_permintaan = 1';
                $data = array(
                    'kondisi' => 'Permintaan Service Ditolak Atasan',
                    'approve' => 2,
                    'jenis_permintaan' => 1
                );
                $this->db->where('id_permintaan', $id);
              ...
              $query2 = "insert into tbl_permintaan_log
                ...
                $data = array(
                    'kondisi' => 'Permintaan Barang Ditolak Atasan',
                    'approve' => 2,
                    'jenis_permintaan' => 2
                );
                $this->db->where('id_permintaan', $id);
             ...
             $query2 = "insert into tbl_permintaan_log
                (id, id_permintaan, statuz, keterangan, pada, oleh, ip_add) 
                values 
                (concat(uuid_short()), ?, 'Permintaan Barang Ditolak Atasan', ?, now(), ?, ?);";
                ...
                $data = array(
                    'kondisi' => 'Permintaan Aplikasi Ditolak Atasan',
                    'approve' => 2,
                    'jenis_permintaan' => 3
                );
                $this->db->where('id_permintaan', $id);
             ...
             $query2 = "insert into tbl_permintaan_log
                (id, id_permintaan, statuz, keterangan, pada, oleh, ip_add) 
                values 
                (concat(uuid_short()), ?, 'Permintaan Aplikasi Ditolak Atasan', ?, now(), ?, ?);";
